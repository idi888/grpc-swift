...
open class ServiceServer {
    ...
    public init(address: String, serviceProviders: [ServiceProvider], loopTimeout: TimeInterval = -1) {
        gRPC.initialize()
    ...
    public init(address: String, certificateString: String, keyString: String, rootCerts: String? = nil, serviceProviders: [ServiceProvider], loopTimeout: TimeInterval = -1) {
        gRPC.initialize()
        self.address = address
    ...
    /// Create a server that accepts secure connections.
    public init?(address: String, certificateURL: URL, keyURL: URL, rootCertsURL: URL? = nil, serviceProviders: [ServiceProvider], loopTimeout: TimeInterval = -1) {
